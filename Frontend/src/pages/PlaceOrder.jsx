        ...
        <div className='mt-8'>
          ...
          <div className='mt-12'>
            ...
            <div className='flex gap-3 flec-col lg:flex-row'>
              ...
              <div onClick={()=>setMethod('razorpay')} className='flec items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'razorpay' ? 'bg-green-400' : ''}`}></p>

                <img className='h-5 mx-4' src={assets.razorpay_logo} alt="" />
              </div>
              <div onClick={()=>setMethod('cod')} className='flec items-center gap-3 border p-2 px-3 cursor-pointer'>
            ...
            <div className='w-full text-end mt-8'>
              <button onClick= {()=>navigate('./Orders.jsx') }className='bg-black text-white px-16 py-3 text-sm'>PLACE ORDER</button>
            </div>
