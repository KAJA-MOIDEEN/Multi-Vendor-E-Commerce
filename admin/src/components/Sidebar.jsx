...
const Sidebar = () => {
  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2'>
        ...
        <NavLink className="flex items-center gap-3 border border-gray-300 boroder-r-0 px-3 py-3 rounded-l" to="/add">
        ...
        <NavLink className="flex items-center gap-3 border border-gray-300 boroder-r-0 px-3 py-3 rounded-l" to="/vendor-list">
